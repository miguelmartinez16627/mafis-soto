...
export default function Dashboard({ user, onLogout }) {
    ...
    const Sidebar = () => (
        ...
        >
            ...
            <button
                className={`btn btn-sm mb-2 ${seccion === "activos" ? "btn-primary" : "btn-outline-primary"
                    }`}
            ...
            <button
                className={`btn btn-sm mb-2 ${seccion === "reportes" ? "btn-primary" : "btn-outline-primary"
                    }`}
            ...
            {["administrador", "tecnico"].includes(user.rol) && (
                <button
                    className={`btn btn-sm mb-2 ${seccion === "ordenes" ? "btn-primary" : "btn-outline-primary"
                        }`}
            ...
            {user.rol === "administrador" && (
                <button
                    className={`btn btn-sm mb-2 ${seccion === "usuarios" ? "btn-primary" : "btn-outline-primary"
                        }`}
